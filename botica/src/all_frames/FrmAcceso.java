...
int veces=0;
     ...
     */
    public FrmAcceso() {
        initComponents(); setTitle("Acceso al Sistema");
        setLocationRelativeTo(this);
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/logo.png")).getImage());
    }
    public void Acceso(){
        if(control.Verificarconsulta("select *from empleado where nom_user='"+txUsuario.getText()+"'"+"and psw='"+psw.getText  ()+"'")){
        new crudCliente().setVisible(true);
                ...
                JOptionPane.showMessageDialog(null,"Llevas un intento");
                    ...
                    if(veces==3){
                      JOptionPane.showMessageDialog(null,"Se cumplio las "+veces+"Oportunidades");
                      dispose();
                }
                else{
                      JOptionPane.showMessageDialog(null,"Llevas "+veces+"Oportunidades");
                        }
        }
                }
}
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Bienvenidos al Sistema", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Microsoft Tai Le", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)
                            .addComponent(psw))))
